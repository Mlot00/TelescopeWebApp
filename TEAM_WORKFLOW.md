...
- Handler API + walidacja requestu: `backend/app/views.py` (`theta2`)
- Podpięcie endpointu URL: `backend/app/urls.py`
...
- Handler API: `backend/app/views.py` (`skymap`)
- URL routing: `backend/app/urls.py`
- Schemy: `backend/app/domain/schemas.py`
...
- Handler API: `backend/app/views.py` (`spectrum`)
- URL routing: `backend/app/urls.py`
- Schemy: `backend/app/domain/schemas.py`
...
- Handler API: `backend/app/views.py` (`lightcurve`)
- URL routing: `backend/app/urls.py`
- Schemy: `backend/app/domain/schemas.py`
...
- API handlers i kontrakty endpointów: `backend/app/views.py` + `backend/app/urls.py`
...
## Uwaga architektoniczna (ważne)
Bieżący backend produkcyjny działa w Django: endpointy są realizowane przez funkcje w `backend/app/views.py` i podpinane w `backend/app/urls.py`.
Katalog `backend/app/api/routes/` traktujemy jako materiał referencyjny po wcześniejszym szkielecie, **nie** jako aktywną ścieżkę integracji endpointów.
